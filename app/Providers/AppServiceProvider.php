...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(\App\Contracts\Repositories\RoomDailyRateRepositoryInterface::class, \App\Repositories\RoomDailyRateRepository::class);
        $this->app->bind(\App\Contracts\Services\RoomPricingServiceInterface::class, \App\Services\RoomPricingService::class);
