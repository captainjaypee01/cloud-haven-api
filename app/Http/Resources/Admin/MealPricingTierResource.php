...
class MealPricingTierResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'adult_extra_guest_fee' => $this->adult_extra_guest_fee ? (float) $this->adult_extra_guest_fee : null,
            'child_extra_guest_fee' => $this->child_extra_guest_fee ? (float) $this->child_extra_guest_fee : null,
