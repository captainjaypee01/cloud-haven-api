                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;box-shadow:0 2px 6px rgba(60,72,88,.08);border:1px solid #eee;">
                    ...
                    <tr>
                        <td style="padding:0 32px 24px 32px;">
                            ...
                            <p style="margin-bottom:24px;font-size:15px;">Thank you for your reservation! <strong>Your booking is on hold for 15 minutes.</strong> Please complete your payment to secure your room.</p>
                            <div style="background:#f6f6f6;border-radius:8px;padding:20px 24px;margin-bottom:24px;">
                                ...
                                <div style="font-size:15px;margin-bottom:10px;"><strong>Check-In:</strong> {{ $booking->check_in_date }} at {{ $booking->check_in_time }}</div>
                                <div style="font-size:15px;margin-bottom:10px;"><strong>Check-Out:</strong> {{ $booking->check_out_date }} at {{ $booking->check_out_time }}</div>
                                ...
                                <div style="font-size:15px;margin-bottom:10px;"><strong>Payment Due:</strong> {{ $booking->reserved_until }}</div>
                            </div>
                            ...
                            <a href="{{ config('app.frontend_url') . '/booking/' . $booking->reference_number . '/payment' }}"
                                style="display:inline-block;padding:12px 32px;background:#00B8D4;color:#fff;border-radius:6px;text-decoration:none;font-size:16px;font-weight:bold;margin-top:16px;">Pay Now</a>
                            <p style="font-size:13px;color:#d44;margin-top:16px;">If payment is not received by the due time above, your reservation will be cancelled.</p>
