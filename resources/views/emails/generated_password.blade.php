        ...
        <tr>
            <td align="center" style="padding:32px 0;">
                <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;box-shadow:0 2px 6px rgba(60,72,88,.08);border:1px solid #eee;">
                    ...
                    <tr>
                        <td style="padding:0 32px 24px 32px;">
                            <p style="margin-bottom:16px;font-size:16px;">Hi {{ $firstName }},</p>
                            <p style="margin-bottom:24px;font-size:15px;">An account has been created for you. Please use the temporary password below to log in to your account:</p>
                            ...
                            <a href="{{ config('app.frontend_url') }}/login" style="display:inline-block;padding:12px 32px;background:#00B8D4;color:#fff;border-radius:6px;text-decoration:none;font-size:16px;font-weight:bold;margin-top:16px;">Login Now</a>
                            <p style="margin:36px 0 0 0;font-size:14px;">For your security, please change your password after logging in.</p>
                            <p style="margin:16px 0 0 0;font-size:14px;">Thank you,<br>The {{ config('app.name') }} Team</p>
                        </td>
                    </tr>
                </table>
                ...
                <div style="font-size:11px;text-align:center;margin-top:10px;color:#666;">
                    *** This email notification was sent because an account was created for you at {{ config('app.name') }}. ***
                </div>
            </td>
        </tr>
    </table>
