        ...
        <div class="email-wrapper">
            <div class="email-content">
                ...
                <div class="content">
                    ...
                    <p style="margin-bottom:12px;font-size:15px;padding-left:16px;">Thank you for your payment. Your {{ $isDayTour ? 'Day Tour' : 'accommodation' }} booking is now <strong>confirmed</strong>!</p>
