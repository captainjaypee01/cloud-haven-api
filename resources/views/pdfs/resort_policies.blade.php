...
<head>
    <meta charset="utf-8">
    <title>Netania De Laiya - Resort Policies</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h2>Resort Policies & House Rules</h2>
    </div>
    ...
    <div class="footer">
        <p>This document contains the official policies of Netania De Laiya Resort.</p>
