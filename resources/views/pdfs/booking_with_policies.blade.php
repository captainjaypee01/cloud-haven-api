...
<body>
    ...
    <div class="section">
        ...
        <div class="booking-details">
            ...
            <div class="detail-group">
                ...
                @endphp
                <p><strong>Total Paid:</strong> {{ $fmtMoney($totalPaid) }}</p>
                <p><strong>Remaining Balance:</strong> {{ $fmtMoney($remainingBalance) }}</p>
            </div>
        </div>
    ...
    <div class="section">
        ...
        <p style="margin-top: 12px;">Above all, we aim to ensure that all guests—both with and without pets—enjoy a safe, pleasant, and memorable stay at Netania de Laiya.</p>
    </div>
